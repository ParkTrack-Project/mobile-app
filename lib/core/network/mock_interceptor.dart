...
// Mock interceptor for development when the real API is not yet available.
// Remove or disable (set kUseMocks = false) once the backend is deployed.
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    if (method == 'GET' && path.startsWith('/zones')) {
      return handler.resolve(_response(options, [
        _mockZone(
          ...
          pay: 0,
          ring: [
            [37.611, 55.7515], [37.613, 55.7515],
            [37.613, 55.7525], [37.611, 55.7525],
            [37.611, 55.7515],
          ],
        ),
        _mockZone(
          ...
          pay: 100,
          ring: [
            [37.621, 55.749], [37.623, 55.749],
            [37.623, 55.750], [37.621, 55.750],
            [37.621, 55.749],
          ],
        ),
      ]));
    ...
    if (method == 'POST' && path == '/routing/new') {
      return handler.resolve(_response(options, {
        ...
        'selectedZoneId': 101,
        'arrivalTime': '14:35',
        'deeplinkUrl': 'yandexnavi://build_route_on_map?lat_to=55.7558&lon_to=37.6173&appmetrica_tracking_id=1178268795219767552',
        'routeGeometry': null,
        'candidates': [],
      }));
    }
