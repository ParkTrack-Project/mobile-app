...
public class Utils {
  ...
  public static DrivingOptions drivingOptionsFromJson(Map<String, Object> json) {
    AvoidanceFlags avoidanceFlags = new AvoidanceFlags(
      Boolean.TRUE.equals(json.get("avoidTolls")),
      Boolean.TRUE.equals(json.get("avoidUnpaved")),
      Boolean.TRUE.equals(json.get("avoidPoorConditions")),
      false,
      false,
      false,
      false,
